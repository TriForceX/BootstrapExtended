...
set_site_transient('wpmdb_dbrains_api_down','<strong>Manually updated</strong>. Take a look on the main plugin file if you want disable or use a real license.',1);
set_site_transient('wpmdb_upgrade_data','<strong>Manually updated</strong>. Take a look on the main plugin file if you want disable or use a real license.',1);
