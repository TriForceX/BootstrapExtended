				...
				<ul class="navbar-nav ml-auto mr-sm-auto  ml-lg-auto mr-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown01">
							...
							<a class="dropdown-item" href="http://php.net/" target="_blank">PHP</a>
							<a class="dropdown-item" href="https://wordpress.org/" target="_blank">WordPress</a>
		...
		<table class="table table-bordered table-striped js-options-table">
			...
			<tbody>
				...
				<tr>
					...
					<td>Alternative to change or disable the modal animation. You can choose between <code>true</code>, <code>false</code> or <code>'alt'</code> for an alternative animation.</td>
				</tr>
			</tbody>
		</table>
