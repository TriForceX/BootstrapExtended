...
<script src="<?php echo get_bloginfo('template_url'); ?>/resources/lightgallery/js/lg-thumbnail.js"></script>
<script src="<?php echo get_bloginfo('template_url'); ?>/resources/lightgallery/js/lg-video.js"></script>
<script src="<?php echo get_bloginfo('template_url'); ?>/resources/lightgallery/js/lg-autoplay.js"></script>
<script src="<?php echo get_bloginfo('template_url'); ?>/resources/lightgallery/js/lg-zoom.js"></script>
<script src="<?php echo get_bloginfo('template_url'); ?>/resources/lightgallery/js/lg-hash.js"></script>
