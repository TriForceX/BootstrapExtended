...
<form method="post" action="setup-config-base.php?step=2" id="form-step-2">
	...
	<table class="form-table" id="form-table-local" role="presentation">
		<thead>
			<tr>
		...
		<tbody style="display: none">
			<tr>
				...
				<td><input name="dbname" id="dbname" aria-describedby="dbname-desc" type="text" size="25" value="<?php echo sanitize_title_2( __( 'Database', 'websitebase' ) . ' ' . __( 'Local', 'websitebase' ) ); ?>" /></td>
				<td><?php _e( 'The name of the database you want to use with WordPress.' ); ?></td>
			</tr>
			<tr>
				<th scope="row"><label for="uname"><?php _e( 'Username' ); ?></label></th>
				<td><input name="uname" id="uname" aria-describedby="uname-desc" type="text" size="25" value="<?php echo sanitize_title_2( __( 'User' ) . '_' . __( 'Local', 'websitebase' ) ); ?>" /></td>
				<td><?php _e( 'Your database username.' ); ?> <?php _e('Usually is <code>root</code>', 'websitebase'); ?>.</td>
			</tr>
			<tr>
				<th scope="row"><label for="pwd"><?php _e( 'Password' ); ?></label></th>
				<td><input name="pwd" id="pwd" aria-describedby="pwd-desc" type="text" size="25" value="<?php echo sanitize_title_2( __( 'Password' ) . '_' . __( 'Local', 'websitebase' ) ); ?>" autocomplete="off" /></td>
			...
			<tr>
				...
				<td><input name="dbhost" id="dbhost" aria-describedby="dbhost-desc" type="text" size="25" value="localhost" /></td>
				<td><?php
	...
	<table class="form-table" id="form-table-production" role="presentation">
		<thead>
			<tr>
		...
		<tbody style="display: none">
			<tr>
				...
				<td><input name="dbname_2" id="dbname_2" aria-describedby="dbname_2-desc" type="text" size="25" value="<?php echo sanitize_title_2( __( 'Database', 'websitebase') . ' ' . __( 'Production', 'websitebase' ) ); ?>" /></td>
				<td><?php _e( 'The name of the database you want to use with WordPress.' ); ?></td>
			</tr>
			<tr>
				<th scope="row"><label for="uname_2"><?php _e( 'Username' ); ?></label></th>
				<td><input name="uname_2" id="uname_2" aria-describedby="uname_2-desc" type="text" size="25" value="<?php echo sanitize_title_2( __( 'User') . '_' . __( 'Production', 'websitebase' ) ); ?>" /></td>
				<td><?php _e( 'Your database username.' ); ?></td>
			</tr>
			<tr>
				<th scope="row"><label for="pwd_2"><?php _e( 'Password' ); ?></label></th>
				<td><input name="pwd_2" id="pwd_2" aria-describedby="pwd_2-desc" type="text" size="25" value="<?php echo sanitize_title_2( __( 'Password') . '_' . __( 'Production', 'websitebase' ) ); ?>" autocomplete="off" /></td>
				<td><?php _e( 'Your database password.' ); ?></td>
			</tr>
			<tr>
				<th scope="row"><label for="dbhost_2"><?php _e( 'Database Host' ); ?></label></th>
				<td><input name="dbhost_2" id="dbhost_2" aria-describedby="dbhost_2-desc" type="text" size="25" value="localhost" /></td>
				<td><?php
					/* translators: %s: localhost */
					printf( __( 'You should be able to get this info from your web host, if %s doesn&#8217;t work.' ), '<code>localhost</code>' );
				?></td>
	...
	<table class="form-table" id="form-table-more" role="presentation">
		<thead>
			<tr>
		...
		<tbody style="display: none">
			<tr>
				...
				<td><input name="prefix" id="prefix" aria-describedby="prefix-desc" type="text" value="wp_" size="25" /></td>
			...
			<tr>
				...
				<td><select name="cron" id="cron" aria-describedby="cron-desc">
			...
			<tr>
				...
				<td><select name="https" id="https" aria-describedby="https-desc">
			...
			<tr>
				...
				<td><select name="www" id="www" aria-describedby="www-desc">
						<option value="false" default><?php _e( 'Disabled', 'websitebase' ); ?></option>
						<option value="true"><?php _e( 'Enabled', 'websitebase' ); ?></option>
					</select></td>
