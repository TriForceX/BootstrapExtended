 ...
 *
 * TriForce: Added defaultTimeNoInput and padZero Options- To-Do: Disable tab-focus option
 */
(function($, window, document) {
  ...
  var Timepicker = function(element, options) {
    ...
    this.defaultTimeNoInput = options.defaultTimeNoInput; //TriForce
    ...
    this.padZero = options.padZero; //TriForce
  ...
  Timepicker.prototype = {
    ...
    updateElement: function() { 
		if(this.defaultTimeNoInput){ //TriForce
			this.defaultTimeNoInput = false;
		}
		else{
    ...
    updateWidget: function() {
      ...
      var hour = this.padZero ? ( this.hour.toString().length === 1 ? '0' + this.hour : this.hour ) : this.hour, //TriForce
  ...
  $.fn.timepicker.defaults = {
    defaultTime: 'current',
    defaultTimeNoInput: false, //TriForce
    disableFocus: false,
