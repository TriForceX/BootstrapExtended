 ...
 * 
 */var JSmainUrl='';var JSmainLang=$('body').data('js-lang');var JSmainDebug=$('body').data('js-debug');var JSisHome=$('body').data('js-home');var JSisMobile=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|BB10|PlayBook|MeeGo/i.test(navigator.userAgent);function JSexist(elem){return elem.length>0}
...
$(this).lightGallery({selector:galSelector+', .lg-thumb-prev, .lg-thumb-next',thumbnail:galThumbnail,download:galDownload,autoplayControls:galAutoplay,hash:galGalleryMode===!0?!1:!0,loop:galLoop,share:galShare,galleryId:galID,hideBarsDelay:galHideDelay,})})}}
