...
function JSresponsiveCode()
{
	...
	var bodyScreen = {'xs'	: { 'up' : parseFloat('575.98'), 'down' : parseFloat('576') },	//up: 575.98, down: 576
					  'sm'	: { 'up' : parseFloat('767.98'), 'down' : parseFloat('768') }, 	//up: 767.98, down: 768
					  'md'	: { 'up' : parseFloat('991.98'), 'down' : parseFloat('992') }, 	//up: 991.98, down: 992
					  'lg'	: { 'up' : parseFloat('1199.98'), 'down' : parseFloat('1200') }, 	//up: 1199.98, down: 1200
					  'xl'	: { 'up' : parseFloat('1359.98'), 'down' : parseFloat('1366') }}; 	//up: 1359.98, down: 1366
...
{	
	...
	if(target.find('.JStextCutInner').length == 0)
	{
		target.wrapInner('<div class="JStextCutInner"><span></span></div>');
	}
}
...
function JStableScroll(element, color)
{
	...
	element.each(function(index){
		...
		{
			element.addClass('JStableScroll');
		}
